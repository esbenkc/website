!(function (e, t) {
  ...
  var e,
    t =
      ...
      e.exports),
    i = (t.defaults, t.getDefaults, t.changeDefaults, /[&<>"']/),
    a = /[&<>"']/g,
    l = /[<>"']|&(?!#?\w+;)/,
    o = /[<>"']|&(?!#?\w+;)/g,
    c = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
  ...
  var y = function (e, t) {
      if (t) {
        if (i.test(e)) return e.replace(a, n);
      } else if (l.test(e)) return e.replace(o, n);
      return e;
    },
    _ = u,
    z = function (n, e) {
    ...
    $ = function (e, t, n) {
      if (e) {
        var r;
        try {
          r = decodeURIComponent(u(n)).replace(f, "").toLowerCase();
        } catch (e) {
          return null;
        }
        if (
        ...
        (t.code = function (e, t) {
          ...
          if (n) {
            ...
            return {
              ...
              text: this.options.pedantic ? i : I(i, "\n"),
            };
          }
        }),
        (t.fences = function (e) {
  ...
  (B.def = P(B.def)
    ...
    (B.bullet = /(?:[*+-]|\d{1,9}\.)/),
    (B.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
    (B.item = P(B.item, "gm").replace(/bull/g, B.bullet).getRegex()),
    (B.list = P(B.list)
  ...
  (F.em = P(F.em)
    ...
    (F.link = P(F.link)
      ...
      .getRegex()),
    (F.reflink = P(F.reflink).replace("label", F._label).getRegex()),
    (F.normal = U({}, F)),
    ...
    (F.gfm = U({}, F.normal, {
      escape: P(F.escape).replace("])", "~|])").getRegex(),
      _extended_email:
    ...
    (F.gfm.url = P(F.gfm.url, "i")
      .replace("email", F.gfm._extended_email)
      .getRegex()),
    (F.breaks = U({}, F.gfm, {
      br: P(F.br).replace("{2,}", "*").getRegex(),
      text: P(F.gfm.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
        ...
        (i.inlineTokens = function (e, t, n, r) {
          ...
          for (
            ...
            if ((i = this.tokenizer.escape(e)))
              ...
              if ((i = this.tokenizer.inlineText(e, r, G)))
                (e = e.substring(i.raw.length)), t.push(i);
              else if (e) {
            ...
            switch ((h = e[v]).type) {
              ...
              case "heading":
                x += this.renderer.heading(
                  ...
                  h.depth,
                  re(this.parseInline(h.tokens, this.textRenderer)),
                  this.slugger
                );
                continue;
              case "code":
                ...
                continue;
              case "table":
                for (l = o = "", i = h.header.length, n = 0; n < i; n++)
                  l += this.renderer.tablecell(
                    this.parseInline(h.tokens.header[n]),
                ...
                for (
                  ...
                  for (
                    l = "", s = (a = h.tokens.cells[n]).length, r = 0;
                    r < s;
                    r++
                  )
                ...
                continue;
              case "blockquote":
                (c = this.parse(h.tokens)), (x += this.renderer.blockquote(c));
                continue;
              case "list":
                for (
                  u = h.ordered,
              ...
              case "text":
                for (
                  ...
                  v + 1 < w && "text" === e[v + 1].type;

                )
                  c +=
                    "\n" +
                    ((h = e[++v]).tokens ? this.parseInline(h.tokens) : h.text);
                x += t ? this.renderer.paragraph(c) : c;
                continue;
              default:
                var y = 'Token with "' + h.type + '" type was not found.';
  ...
  function ue(e, n, r) {
    ...
    try {
      var t = H.lex(e, n);
      return n.walkTokens && ue.walkTokens(t, n.walkTokens), ie.parse(t, n);
    } catch (e) {
      if (
        ((e.message +=
  ...
  return (
    (ue.options = ue.setOptions =
      function (e) {
        return se(ue.defaults, e), ce(ue.defaults), ue;
      }),
    (ue.getDefaults = oe),
    (ue.defaults = he),
    (ue.use = function (l) {
      ...
      l.renderer &&
        (function () {
          ...
          var a = ue.defaults.renderer || new Y();
        ...
        l.tokenizer &&
          (function () {
            ...
            var a = ue.defaults.tokenizer || new D();
            for (var t in l.tokenizer) e(t);
            n.tokenizer = a;
          })(),
        l.walkTokens &&
          ((t = ue.defaults.walkTokens),
          (n.walkTokens = function (e) {
            l.walkTokens(e), t && t(e);
          })),
        ue.setOptions(n);
    }),
    (ue.walkTokens = function (e, t) {
      for (var n, r = g(e); !(n = r()).done; ) {
        ...
        switch ((t(i), i.type)) {
          case "table":
            for (var s, a = g(i.tokens.header); !(s = a()).done; ) {
              var l = s.value;
              ue.walkTokens(l, t);
            }
            for (var o, c = g(i.tokens.cells); !(o = c()).done; )
              for (var h, u = g(o.value); !(h = u()).done; ) {
                var p = h.value;
                ue.walkTokens(p, t);
              }
            break;
          case "list":
            ue.walkTokens(i.items, t);
            break;
          default:
            i.tokens && ue.walkTokens(i.tokens, t);
        }
      }
    }),
    (ue.Parser = ie),
